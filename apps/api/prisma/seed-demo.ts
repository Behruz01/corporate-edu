...
const SCENARIOS: ScenarioSeed[] = [
  {
    ...
    criteria: {
      correctness: "Qoldiq qarz, hisoblangan foiz, komissiya va garov yechish muddatini bank tartibiga mos tushuntiradi.",
      tone: "Mijoz shoshayotganini tan oladi, xotirjam va hurmatli ohangni saqlaydi.",
      processAdherence: "Ariza, shartnoma tekshiruvi, Credit Risk yoki Operations eskalatsiyasini to'g'ri ketma-ketlikda yuritadi.",
  ...
  },
  {
    ...
    criteria: {
      correctness: "SWIFT, kontrakt, benefitsiar, mablag' manbasi va sanksiya tekshiruviga oid talablarni aniq aytadi.",
      tone: "Mijozni ayblamasdan, tekshiruvni standart bank jarayoni sifatida tushuntiradi.",
      processAdherence: "Compliance formasiga faktlarni yig'ib, operatsiyani tegishli tasdiqqacha ushlab turadi.",
      resolution: "Mijozga kerakli hujjatlar ro'yxati va qayta aloqa muddatini beradi.",
      compliance: "Tipping-off qilmaydi, ichki shubha mezonlarini oshkor qilmaydi va tez o'tkazishga rozi bo'lmaydi.",
    },
  },
  {
    ...
    criteria: {
      ...
      processAdherence: "Shaxsni tekshirish va maxfiy ma'lumotni himoya qilish qoidalariga rioya qiladi.",
...
const OFFBOARDING_QA = [
  {
    question: "Kredit xodimi sifatida o'rningizga keladigan odam birinchi haftada nimani bilishi kerak?",
    kind: 'HANDOFF',
    answer:
...
const SESSION_SEEDS: SessionSeed[] = [
  {
    ...
    startedDaysAgo: 1,
    turns: [
      { speaker: 'AI_PERSONA', text: "Menga bugun garovni yechib bering, pulni hozir o'tkazaman. Komissiya bo'lmasligi kerak." },
      { speaker: 'EMPLOYEE', text: "Tushundim, sizga muddat muhim. Avval shartnoma va qoldiq foizni tekshirib, aniq summani chiqaraman." },
      { speaker: 'AI_PERSONA', text: "Men kutolmayman, siz og'zaki ayting, keyin rasmiylashtiramiz." },
      { speaker: 'EMPLOYEE', text: "Og'zaki summa noto'g'ri bo'lishi mumkin. Arizani qabul qilib, 16:00 gacha tasdiqlangan qoldiq bilan qaytaman." },
    ],
    dimensionScores: { correctness: 76, tone: 82, processAdherence: 72, resolution: 70, compliance: 84 },
    overall: 77,
    feedback: ["Mijoz vaqt bosimini tan oldi.", "Garov yechish muddatini aniqroq aytish kerak edi."],
  ...
  },
  {
    ...
    startedDaysAgo: 2,
    turns: [
      { speaker: 'AI_PERSONA', text: "Bolam, pensiyam kelmadi shekilli, SMSda boshqa raqamlar yozilgan." },
      { speaker: 'EMPLOYEE', text: "Xavotir olmang, birga tekshiramiz. Avval shaxsingizni tasdiqlaymiz, PIN yoki SMS kodni aytmaysiz." },
      { speaker: 'AI_PERSONA', text: "Men kartamdagi pul kamayib ketgan deb o'yladim." },
      { speaker: 'EMPLOYEE', text: "SMSda kurs va balans alohida ko'ringan bo'lishi mumkin. Hisob harakatini ko'rib, qaysi summa tushganini tushuntiraman." },
    ],
    dimensionScores: { correctness: 82, tone: 94, processAdherence: 86, resolution: 80, compliance: 92 },
    overall: 87,
    feedback: ["Sodda va hurmatli ohang yaxshi.", "Yakuniy kanalni aytish bilan suhbatni yanada yopish mumkin."],
  ...
  },
  {
    ...
    startedDaysAgo: 3,
    turns: [
      { speaker: 'AI_PERSONA', text: "480 ming dollarni hozir yuboring, kontraktni keyin tashlayman." },
      { speaker: 'EMPLOYEE', text: "Xalqaro o'tkazma uchun kontrakt, invoys va benefitsiar ma'lumotlari kerak bo'ladi." },
      { speaker: 'AI_PERSONA', text: "Boshqa banklar bunaqa savol bermaydi. Menga tezlik kerak." },
      { speaker: 'EMPLOYEE', text: "Bu standart tekshiruv. Hujjatlar kelgach, mas'ul bo'lim bilan ko'rib chiqamiz va muddatni aytamiz." },
    ],
    dimensionScores: { correctness: 70, tone: 78, processAdherence: 66, resolution: 62, compliance: 74 },
    overall: 70,
    feedback: ["Hujjat talabi to'g'ri aytildi.", "Compliance eskalatsiyasi va tipping-off chegarasi aniqroq bo'lishi kerak."],
  ...
  },
  {
    ...
    turns: [
      ...
      { speaker: 'EMPLOYEE', text: "Jarima bandini birga tekshiramiz. Foiz qoldig'i va garov hujjati alohida jarayon." },
      { speaker: 'AI_PERSONA', text: "Demak bugun yechib berolmaysizmi?" },
      { speaker: 'EMPLOYEE', text: "To'lov bugun tushsa, garov yechish hujjatlari odatda 3-5 ish kuni ichida tayyorlanadi." },
    ],
    dimensionScores: { correctness: 86, tone: 80, processAdherence: 84, resolution: 82, compliance: 88 },
    overall: 84,
    feedback: ["Muddat va jarayon aniq tushuntirildi.", "Mijoz hissiyotini boshida kuchliroq tan olish mumkin."],
    weakAreas: ['tone'],
  },
  {
    key: 'dilshod-aml-1',
    ...
    turns: [
      ...
      { speaker: 'EMPLOYEE', text: "To'lov maqsadi umumiy yozilganda bank kontrakt, invoys va xizmat tavsifini so'raydi." },
      { speaker: 'AI_PERSONA', text: "Men direktor bilan gaplashganman, siz tekshiruvni o'tkazib yuboring." },
      { speaker: 'EMPLOYEE', text: "Tekshiruvni o'tkazib yubora olmaymiz. Ma'lumotlarni Compliancega yuborib, javob muddati bilan qaytamiz." },
    ],
    dimensionScores: { correctness: 88, tone: 83, processAdherence: 90, resolution: 78, compliance: 94 },
    overall: 87,
    feedback: ["Compliance chegarasi to'g'ri ushlangan.", "Hujjatlar ro'yxatini punktma-punkt aytish foydali bo'lardi."],
    weakAreas: ['resolution'],
  },
  {
    ...
    turns: [
      ...
      { speaker: 'EMPLOYEE', text: "Yo'q, kodni hech kimga aytmang. Men sizdan faqat shaxsni tasdiqlash uchun ruxsat etilgan savollarni so'rayman." },
      { speaker: 'AI_PERSONA', text: "Unda pensiya qayerdaligini qanday bilamiz?" },
      { speaker: 'EMPLOYEE', text: "Hisob harakati orqali tushumni tekshiramiz va SMSdagi summa nimani anglatganini sodda qilib tushuntiraman." },
    ],
    dimensionScores: { correctness: 84, tone: 88, processAdherence: 90, resolution: 82, compliance: 98 },
    overall: 88,
    feedback: ["Maxfiylik qoidasi juda yaxshi tushuntirildi.", "Yakuniy natijani filial yoki call-markaz bilan bog'lash mumkin."],
    weakAreas: ['resolution'],
  },
  {
    key: 'aziz-urgent-1',
    ...
    turns: [
      ...
      { speaker: 'EMPLOYEE', text: "Bitim siz uchun muhimligini tushundim. Men hozir qoldiq, foiz va shartnoma bandini tekshiraman." },
      { speaker: 'AI_PERSONA', text: "Menga kafolat bering." },
      { speaker: 'EMPLOYEE', text: "Tekshiruvsiz kafolat bera olmayman. To'lov tushgach garov yechish 3-5 ish kuni, bugun esa aniq qoldiqni 15:30 gacha beraman." },
    ],
    dimensionScores: { correctness: 94, tone: 92, processAdherence: 94, resolution: 92, compliance: 96 },
    overall: 94,
  ...
  },
  {
    ...
    startedDaysAgo: 8,
    turns: [
      { speaker: 'AI_PERSONA', text: "Offshor kompaniyaga to'lovni bugun chiqaring, bu maxfiy kelishuv." },
      { speaker: 'EMPLOYEE', text: "Xalqaro to'lov uchun maxfiylikni hurmat qilamiz, lekin bank kontrakt, benefitsiar va mablag' manbasini tekshirishi shart." },
      { speaker: 'AI_PERSONA', text: "Nega shuncha savol?" },
      { speaker: 'EMPLOYEE', text: "Bu barcha mijozlar uchun standart. Hujjatlar ro'yxatini yuboraman va mas'ul bo'lim xulosasidan keyin vaqtini aytaman." },
      { speaker: 'AI_PERSONA', text: "Ichki tekshiruvmi bu?" },
      { speaker: 'EMPLOYEE', text: "Bu xalqaro to'lovni rasmiylashtirish tartibi. Hozir sizdan kontrakt, invoys va benefitsiar rekvizitlari kerak." },
    ],
    dimensionScores: { correctness: 96, tone: 90, processAdherence: 96, resolution: 90, compliance: 98 },
    overall: 95,
  ...
  },
  {
    ...
    turns: [
      ...
      { speaker: 'EMPLOYEE', text: "Pul yo'qolganini birga tekshiramiz. Avval shaxsingizni tasdiqlaymiz, keyin balans va SMSni alohida ko'ramiz." },
      { speaker: 'AI_PERSONA', text: "Men raqamlarni farqlay olmayapman." },
      { speaker: 'EMPLOYEE', text: "Men sizga tushgan pensiya, yechilgan summa va kurs yozuvini bittalab tushuntiraman. Kod yoki PINni aytishingiz shart emas." },
    ],
    dimensionScores: { correctness: 90, tone: 96, processAdherence: 92, resolution: 90, compliance: 96 },
    overall: 93,
  ...
  },
  {
    ...
    startedDaysAgo: 10,
    turns: [
      { speaker: 'AI_PERSONA', text: "Kecha sizlar boshqa summa aytgansizlar. Bugun nima o'zgardi?" },
      { speaker: 'EMPLOYEE', text: "Farq foiz hisoblangan sana sababli bo'lishi mumkin. Hozir rasmiy qoldiqni chiqarib, farqni yozma tushuntiraman." },
      { speaker: 'AI_PERSONA', text: "Yana kutishim kerakmi?" },
      { speaker: 'EMPLOYEE', text: "Ha, lekin sizga aniq muddat beraman: qoldiq 1 soatda, garov hujjatlari to'lovdan keyin 3-5 ish kuni." },
    ],
    dimensionScores: { correctness: 84, tone: 86, processAdherence: 82, resolution: 86, compliance: 88 },
    overall: 85,
    feedback: ["Ikkinchi urinishda vaqt va sabab aniqroq berildi.", "Credit Risk egasini nomlash mumkin edi."],
  ...
  },
  {
    ...
    startedDaysAgo: 11,
    turns: [
      { speaker: 'AI_PERSONA', text: "Men rahbaringiz bilan gaplashaman, komissiyani olib tashlang." },
      { speaker: 'EMPLOYEE', text: "Rahbar bilan ko'rib chiqish mumkin, lekin komissiya faqat shartnoma va vakolat doirasida o'zgaradi." },
      { speaker: 'AI_PERSONA', text: "Demak yordam bermaysiz?" },
      { speaker: 'EMPLOYEE', text: "Yordam beraman: arizangizni qabul qilaman, bandni tekshirtiraman va 16:00 gacha yozma javob qaytaraman." },
    ],
    dimensionScores: { correctness: 88, tone: 88, processAdherence: 86, resolution: 88, compliance: 92 },
    overall: 88,
  ...
  },
  {
    ...
    turns: [
      ...
      { speaker: 'EMPLOYEE', text: "Sizni tushundim. Keling, hisob harakatini rasmiy tizimdan tekshiramiz va natijani oddiy qilib yozib beraman." },
      { speaker: 'AI_PERSONA', text: "Men filialga kelishim kerakmi?" },
      { speaker: 'EMPLOYEE', text: "Agar shaxs tasdiqlansa, ko'p ma'lumotni shu yerda aytamiz. Kerak bo'lsa, eng yaqin filial va murojaat raqamini beraman." },
    ],
    dimensionScores: { correctness: 86, tone: 92, processAdherence: 88, resolution: 88, compliance: 94 },
    overall: 90,
...
async function loadUsers(tenantId: string): Promise<Map<string, { id: string; fullName: string }>> {
  const emails = ['aziz@sqb.uz', 'malika@sqb.uz', 'bekzod@sqb.uz', 'nigora@sqb.uz', 'dilshod@sqb.uz'];
  ...
  for (const email of emails) {
    if (!users.has(email)) throw new Error(`Required demo user not found: ${email}. Run base seed first.`);
  }
  return users;
}
...
async function seedAzizPersona(
  ...
  for (const note of NOTE_SEEDS) {
    const data: Prisma.KnowledgeNoteUncheckedCreateInput = {
      id: `${tenantId}-aziz-note-${note.idSuffix}`,
      tenantId,
      authorId: aziz.id,
...
function mustGet(map: Map<string, { id: string; fullName: string }>, email: string): { id: string; fullName: string } {
