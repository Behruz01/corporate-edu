...
import { Home, GraduationCap, BookOpen, Drama, Brain, Users, LogOut } from 'lucide-react';
...
export function ManagerShell(): JSX.Element {
  ...
  return (
    <div className="flex min-h-screen">
      <Sidebar brandSubtitle="Manager">
        <SidebarNav items={NAV.map((n) => ({ to: n.to, label: t(`nav.${n.key}`), icon: n.icon, end: n.to === '/team' ? false : undefined }))} />
      </Sidebar>
